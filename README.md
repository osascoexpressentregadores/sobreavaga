# Gibi de Vaga OE — Versão UX Revisada

Arquivo principal: `index.html`.

## Ajustes desta versão

- Removida qualquer confirmação de leitura.
- CTA principal: **BAIXAR APP**.
- Link oficial Android/Google Play aplicado nos CTAs principais:
  `https://play.google.com/store/apps/details?id=com.osascoexpress&hl=pt`
...
Suba a pasta inteira mantendo esta estrutura:

```text
index.html
assets/
  img/
    01-faca-parte-do-nosso-time.webp
    02-quanto-da-pra-fazer.webp
    03-como-funciona-sua-vaga.webp
